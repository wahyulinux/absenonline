    ...
    <div class="row">
      <div class="input-field col m3 s12">
        <select name="pertemuan">
          ...
          $kelas=$_GET['kelas'];
          $matkul=$_GET['matkul'];
          $result_pertemuan=mysqli_query($conn, "SELECT pertemuan FROM tbl_pertemuan WHERE pertemuan=1 and kelas='$kelas' and matkul='$matkul' and matkul='$matkul'");
          $row_pertemuan=mysqli_fetch_assoc($result_pertemuan);
          if (!$row_pertemuan['pertemuan']==1) {
            echo '<option value="1">Pertemuan 1</option>';
          };
          $result_pertemuan=mysqli_query($conn, "SELECT pertemuan FROM tbl_pertemuan WHERE pertemuan=2 and kelas='$kelas' and matkul='$matkul'");
          $row_pertemuan=mysqli_fetch_assoc($result_pertemuan);
          if (!$row_pertemuan['pertemuan']==2) {
            echo '<option value="2">Pertemuan 2</option>';
          };
          $result_pertemuan=mysqli_query($conn, "SELECT pertemuan FROM tbl_pertemuan WHERE pertemuan=3 and kelas='$kelas' and matkul='$matkul'");
          $row_pertemuan=mysqli_fetch_assoc($result_pertemuan);
          if (!$row_pertemuan['pertemuan']==3) {
            echo '<option value="3">Pertemuan 3</option>';
          };
          $result_pertemuan=mysqli_query($conn, "SELECT pertemuan FROM tbl_pertemuan WHERE pertemuan=4 and kelas='$kelas' and matkul='$matkul'");
          $row_pertemuan=mysqli_fetch_assoc($result_pertemuan);
          if (!$row_pertemuan['pertemuan']==4) {
            echo '<option value="4">Pertemuan 4</option>';
          };
          $result_pertemuan=mysqli_query($conn, "SELECT pertemuan FROM tbl_pertemuan WHERE pertemuan=5 and kelas='$kelas' and matkul='$matkul'");
          $row_pertemuan=mysqli_fetch_assoc($result_pertemuan);
          if (!$row_pertemuan['pertemuan']==5) {
            echo '<option value="5">Pertemuan 5</option>';
          };
          $result_pertemuan=mysqli_query($conn, "SELECT pertemuan FROM tbl_pertemuan WHERE pertemuan=6 and kelas='$kelas' and matkul='$matkul'");
          $row_pertemuan=mysqli_fetch_assoc($result_pertemuan);
          if (!$row_pertemuan['pertemuan']==6) {
            echo '<option value="6">Pertemuan 6</option>';
          };
          $result_pertemuan=mysqli_query($conn, "SELECT pertemuan FROM tbl_pertemuan WHERE pertemuan=7 and kelas='$kelas' and matkul='$matkul'");
          $row_pertemuan=mysqli_fetch_assoc($result_pertemuan);
          if (!$row_pertemuan['pertemuan']==7) {
            echo '<option value="7">Pertemuan 7</option>';
          };
          $result_pertemuan=mysqli_query($conn, "SELECT pertemuan FROM tbl_pertemuan WHERE pertemuan=8 and kelas='$kelas' and matkul='$matkul'");
          $row_pertemuan=mysqli_fetch_assoc($result_pertemuan);
          if (!$row_pertemuan['pertemuan']==8) {
            echo '<option value="8">Pertemuan 8</option>';
          };
          $result_pertemuan=mysqli_query($conn, "SELECT pertemuan FROM tbl_pertemuan WHERE pertemuan=9 and kelas='$kelas' and matkul='$matkul'");
          $row_pertemuan=mysqli_fetch_assoc($result_pertemuan);
          if (!$row_pertemuan['pertemuan']==9) {
            echo '<option value="9">Pertemuan 9</option>';
          };
          $result_pertemuan=mysqli_query($conn, "SELECT pertemuan FROM tbl_pertemuan WHERE pertemuan=10 and kelas='$kelas' and matkul='$matkul'");
          $row_pertemuan=mysqli_fetch_assoc($result_pertemuan);
          if (!$row_pertemuan['pertemuan']==10) {
            echo '<option value="10">Pertemuan 10</option>';
          };
          $result_pertemuan=mysqli_query($conn, "SELECT pertemuan FROM tbl_pertemuan WHERE pertemuan=11 and kelas='$kelas' and matkul='$matkul'");
          $row_pertemuan=mysqli_fetch_assoc($result_pertemuan);
          if (!$row_pertemuan['pertemuan']==11) {
            echo '<option value="11">Pertemuan 11</option>';
          };
          $result_pertemuan=mysqli_query($conn, "SELECT pertemuan FROM tbl_pertemuan WHERE pertemuan=12 and kelas='$kelas' and matkul='$matkul'");
          $row_pertemuan=mysqli_fetch_assoc($result_pertemuan);
          if (!$row_pertemuan['pertemuan']==12) {
            echo '<option value="12">Pertemuan 12</option>';
          };
          $result_pertemuan=mysqli_query($conn, "SELECT pertemuan FROM tbl_pertemuan WHERE pertemuan=13 and kelas='$kelas' and matkul='$matkul'");
          $row_pertemuan=mysqli_fetch_assoc($result_pertemuan);
          if (!$row_pertemuan['pertemuan']==13) {
            echo '<option value="13">Pertemuan 13</option>';
          };
          $result_pertemuan=mysqli_query($conn, "SELECT pertemuan FROM tbl_pertemuan WHERE pertemuan=14 and kelas='$kelas' and matkul='$matkul'");
          $row_pertemuan=mysqli_fetch_assoc($result_pertemuan);
          if (!$row_pertemuan['pertemuan']==14) {
            echo '<option value="14">Pertemuan 14</option>';
          };
          $result_pertemuan=mysqli_query($conn, "SELECT pertemuan FROM tbl_pertemuan WHERE pertemuan=15 and kelas='$kelas' and matkul='$matkul'");
          $row_pertemuan=mysqli_fetch_assoc($result_pertemuan);
          if (!$row_pertemuan['pertemuan']==15) {
            echo '<option value="15">Pertemuan 15</option>';
          };
          $result_pertemuan=mysqli_query($conn, "SELECT pertemuan FROM tbl_pertemuan WHERE pertemuan=16 and kelas='$kelas' and matkul='$matkul'");
          $row_pertemuan=mysqli_fetch_assoc($result_pertemuan);
...
if ($_POST['kirim']) {
  ...
  mysqli_query($conn, "INSERT INTO `tbl_pertemuan` VALUES('', '$pertemuan', '$judul_pertemuan', '$kelas', '$jam', '$waktu', '$matkul')");
  ...
  $jumlah_dipilih = count($kehadiran);
    ...
    for($x=0;$x<$jumlah_dipilih;$x++){
      mysqli_query($conn, "INSERT INTO `tbl_kehadiran` VALUES('', '$uid[$x]', '$pertemuan', '$matkul', '$kehadiran[$x]')");
      mysqli_query($conn, "DELETE FROM tbl_log WHERE UID='$uid[$x]'");

    }
    ?>
    <meta http-equiv="refresh" content="0;url=?page=kehadiran&kelas=<?= $kelas ?>&matkul=<?= $matkul ?>"/>
    <?php
